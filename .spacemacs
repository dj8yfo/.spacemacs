...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-themes '(moe-dark darkokai doom-molokai doom-snazzy tao-yin grandshell material-light
...
;; test change
   ...
   dotspacemacs-default-font '("-PfEd-Agave-normal-normal-normal-*-*-*-*-*-m-0-iso10646-1" )
