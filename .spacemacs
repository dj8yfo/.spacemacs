...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-themes '(doom-molokai material material-light badwolf grandshell spolsky darkokai monokai moe-dark tangotango  farmhouse-dark
...
;; test change
   ...
   dotspacemacs-default-font '("-ADBO-Hasklig-extralight-normal-normal-*-15-*-*-*-m-0-iso10646-1"        )
...
\"###..######.######\",
\"###########.######\" };")) t)
 '(helm-ag-base-command "rg --no-heading -L -S --no-ignore --hidden")
