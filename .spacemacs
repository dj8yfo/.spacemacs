...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Terminus Regular"
                               :size 12
                               :weight normal
                               :width normal)
